...
"""
This is a preprocessing script to annotate and build tile matrix for scATAC-seq
Output
...
if __name__ == "__main__":
    ...
    window_size = 5000
    n_jobs = 4
    exclude_chroms=["X", "Y", "chrM", "chrX", "chrY"]

    fragment_file = os.path.join(ranger_dir, "atac_fragments.tsv.gz")
    assert os.path.exists(fragment_file)
    ...
    ##################################################
    out_file = os.path.join(out_dir, f"{sample}.atac.h5ad")
